...
function layoutWithLines(prepared, maxWidth, lineHeight) {
  ...
  const lineCount2 = walkPreparedLinesRaw(getInternalPrepared(prepared), maxWidth, (width, startSegmentIndex, startGraphemeIndex, endSegmentIndex, endGraphemeIndex) => {
  ...
  return { lineCount: lineCount2, height: lineCount2 * lineHeight, lines };
}

// src/browser.ts
var helloText = "Hello world from Pretext";
var helloFont = "32px Arial";
var helloLineHeight = 40;
var helloWidth = 280;
var output = document.querySelector(".pretext-output");
var packageName = document.querySelector('[data-field="packageName"]');
var lineCount = document.querySelector('[data-field="lineCount"]');
var measuredHeight = document.querySelector('[data-field="height"]');
